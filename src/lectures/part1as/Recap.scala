...
object Recap extends App {
  ...
  val aConditinedVal = if (aCondition) 42 else 65
  ...
  @tailrec def factorial(n: Int, accumularor: Int): Int =
    if (n <= 0) accumularor
    else factorial(n - 1, n * accumularor)
  ...
  //scala collections Seqs, Arrays, List
  val aMap = Map (
    "Eero" -> 260,
    "Hannu" -> 124
    )
